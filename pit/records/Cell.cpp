#include "particles/pit/records/Cell.h"
   ...
   _persistentRecords(persistentRecords._cellIndex, persistentRecords._meanVelocity, persistentRecords._isInside, persistentRecords._state, persistentRecords._evenFlags, persistentRecords._accessNumber, persistentRecords._numberOfLoadsFromInputStream, persistentRecords._numberOfStoresToOutputStream) {
      
   }
   
   
   particles::pit::records::Cell::Cell(const int& cellIndex, const tarch::la::Vector<DIMENSIONS,double>& meanVelocity, const bool& isInside, const State& state, const std::bitset<DIMENSIONS>& evenFlags, const tarch::la::Vector<DIMENSIONS_TIMES_TWO,short int>& accessNumber, const int& numberOfLoadsFromInputStream, const int& numberOfStoresToOutputStream):
   _persistentRecords(cellIndex, meanVelocity, isInside, state, evenFlags, accessNumber, numberOfLoadsFromInputStream, numberOfStoresToOutputStream) {
      
   }
   
   
   particles::pit::records::Cell::Cell(const int& cellIndex, const int& numberOfParticlesInChildren, const tarch::la::Vector<DIMENSIONS,double>& meanVelocity, const bool& isInside, const State& state, const std::bitset<DIMENSIONS>& evenFlags, const tarch::la::Vector<DIMENSIONS_TIMES_TWO,short int>& accessNumber, const int& numberOfLoadsFromInputStream, const int& numberOfStoresToOutputStream):
   _persistentRecords(cellIndex, meanVelocity, isInside, state, evenFlags, accessNumber, numberOfLoadsFromInputStream, numberOfStoresToOutputStream),_numberOfParticlesInChildren(numberOfParticlesInChildren) {
   ...
   particles::pit::records::CellPacked particles::pit::records::Cell::convert() const{
      ...
      void particles::pit::records::Cell::initDatatype() {
         ...
         }
         {
            ...
            MPI_Address( const_cast<void*>(static_cast<const void*>(&(dummyCell[0]._persistentRecords._isInside))), 		&disp[2] );
            MPI_Address( const_cast<void*>(static_cast<const void*>(&(dummyCell[0]._persistentRecords._state))), 		&disp[3] );
...
_persistentRecords(persistentRecords._cellIndex, persistentRecords._meanVelocity, persistentRecords.getIsInside(), persistentRecords.getState(), persistentRecords.getEvenFlags(), persistentRecords._accessNumber, persistentRecords._numberOfLoadsFromInputStream, persistentRecords._numberOfStoresToOutputStream) {
   assertion((DIMENSIONS+3 < (8 * sizeof(short int))));
...
particles::pit::records::Cell::PersistentRecords::PersistentRecords(const int& cellIndex, const tarch::la::Vector<DIMENSIONS,double>& meanVelocity, const bool& isInside, const State& state, const int& level, const std::bitset<DIMENSIONS>& evenFlags, const tarch::la::Vector<DIMENSIONS_TIMES_TWO,short int>& accessNumber):
_cellIndex(cellIndex),
_meanVelocity(meanVelocity),
_isInside(isInside),
_state(state),
...
particles::pit::records::Cell::Cell(const PersistentRecords& persistentRecords):
_persistentRecords(persistentRecords._cellIndex, persistentRecords._meanVelocity, persistentRecords._isInside, persistentRecords._state, persistentRecords._level, persistentRecords._evenFlags, persistentRecords._accessNumber) {

}


particles::pit::records::Cell::Cell(const int& cellIndex, const tarch::la::Vector<DIMENSIONS,double>& meanVelocity, const bool& isInside, const State& state, const int& level, const std::bitset<DIMENSIONS>& evenFlags, const tarch::la::Vector<DIMENSIONS_TIMES_TWO,short int>& accessNumber):
_persistentRecords(cellIndex, meanVelocity, isInside, state, level, evenFlags, accessNumber) {

}


particles::pit::records::Cell::Cell(const int& cellIndex, const int& numberOfParticlesInChildren, const tarch::la::Vector<DIMENSIONS,double>& meanVelocity, const bool& isInside, const State& state, const int& level, const std::bitset<DIMENSIONS>& evenFlags, const tarch::la::Vector<DIMENSIONS_TIMES_TWO,short int>& accessNumber):
_persistentRecords(cellIndex, meanVelocity, isInside, state, level, evenFlags, accessNumber),_numberOfParticlesInChildren(numberOfParticlesInChildren) {
...
void particles::pit::records::Cell::initDatatype() {
   ...
   }
   {
      ...
      MPI_Address( const_cast<void*>(static_cast<const void*>(&(dummyCell[0]._persistentRecords._isInside))), 		&disp[2] );
      MPI_Address( const_cast<void*>(static_cast<const void*>(&(dummyCell[0]._persistentRecords._state))), 		&disp[3] );
      MPI_Address( const_cast<void*>(static_cast<const void*>(&(dummyCell[0]._persistentRecords._level))), 		&disp[4] );
...
particles::pit::records::CellPacked::PersistentRecords::PersistentRecords(const int& cellIndex, const tarch::la::Vector<DIMENSIONS,double>& meanVelocity, const bool& isInside, const State& state, const int& level, const std::bitset<DIMENSIONS>& evenFlags, const tarch::la::Vector<DIMENSIONS_TIMES_TWO,short int>& accessNumber):
_cellIndex(cellIndex),
_meanVelocity(meanVelocity),
_level(level),
_accessNumber(accessNumber) {
...
particles::pit::records::CellPacked::CellPacked(const PersistentRecords& persistentRecords):
_persistentRecords(persistentRecords._cellIndex, persistentRecords._meanVelocity, persistentRecords.getIsInside(), persistentRecords.getState(), persistentRecords._level, persistentRecords.getEvenFlags(), persistentRecords._accessNumber) {
assertion((DIMENSIONS+3 < (8 * sizeof(short int))));

}


particles::pit::records::CellPacked::CellPacked(const int& cellIndex, const tarch::la::Vector<DIMENSIONS,double>& meanVelocity, const bool& isInside, const State& state, const int& level, const std::bitset<DIMENSIONS>& evenFlags, const tarch::la::Vector<DIMENSIONS_TIMES_TWO,short int>& accessNumber):
_persistentRecords(cellIndex, meanVelocity, isInside, state, level, evenFlags, accessNumber) {
assertion((DIMENSIONS+3 < (8 * sizeof(short int))));
...
}
{
   ...
   MPI_Address( const_cast<void*>(static_cast<const void*>(&(dummyCellPacked[0]._persistentRecords._cellIndex))), 		&disp[0] );
   MPI_Address( const_cast<void*>(static_cast<const void*>(&(dummyCellPacked[0]._persistentRecords._meanVelocity[0]))), 		&disp[1] );
   MPI_Address( const_cast<void*>(static_cast<const void*>(&(dummyCellPacked[0]._persistentRecords._level))), 		&disp[2] );
...
particles::pit::records::Cell::Cell(const PersistentRecords& persistentRecords):
_persistentRecords(persistentRecords._cellIndex, persistentRecords._meanVelocity, persistentRecords._isInside, persistentRecords._state, persistentRecords._evenFlags, persistentRecords._accessNumber, persistentRecords._responsibleRank, persistentRecords._subtreeHoldsWorker, persistentRecords._nodeWorkload, persistentRecords._localWorkload, persistentRecords._totalWorkload, persistentRecords._maxWorkload, persistentRecords._minWorkload, persistentRecords._cellIsAForkCandidate) {

}


particles::pit::records::Cell::Cell(const int& cellIndex, const tarch::la::Vector<DIMENSIONS,double>& meanVelocity, const bool& isInside, const State& state, const std::bitset<DIMENSIONS>& evenFlags, const tarch::la::Vector<DIMENSIONS_TIMES_TWO,short int>& accessNumber, const int& responsibleRank, const bool& subtreeHoldsWorker, const double& nodeWorkload, const double& localWorkload, const double& totalWorkload, const double& maxWorkload, const double& minWorkload, const bool& cellIsAForkCandidate):
_persistentRecords(cellIndex, meanVelocity, isInside, state, evenFlags, accessNumber, responsibleRank, subtreeHoldsWorker, nodeWorkload, localWorkload, totalWorkload, maxWorkload, minWorkload, cellIsAForkCandidate) {

}


particles::pit::records::Cell::Cell(const int& cellIndex, const int& numberOfParticlesInChildren, const tarch::la::Vector<DIMENSIONS,double>& meanVelocity, const bool& isInside, const State& state, const std::bitset<DIMENSIONS>& evenFlags, const tarch::la::Vector<DIMENSIONS_TIMES_TWO,short int>& accessNumber, const int& responsibleRank, const bool& subtreeHoldsWorker, const double& nodeWorkload, const double& localWorkload, const double& totalWorkload, const double& maxWorkload, const double& minWorkload, const bool& cellIsAForkCandidate):
_persistentRecords(cellIndex, meanVelocity, isInside, state, evenFlags, accessNumber, responsibleRank, subtreeHoldsWorker, nodeWorkload, localWorkload, totalWorkload, maxWorkload, minWorkload, cellIsAForkCandidate),_numberOfParticlesInChildren(numberOfParticlesInChildren) {
...
MPI_Address( const_cast<void*>(static_cast<const void*>(&(dummyCell[1]._persistentRecords._cellIndex))), 		&disp[15] );
...
particles::pit::records::CellPacked::CellPacked(const PersistentRecords& persistentRecords):
_persistentRecords(persistentRecords._cellIndex, persistentRecords._meanVelocity, persistentRecords.getIsInside(), persistentRecords.getState(), persistentRecords.getEvenFlags(), persistentRecords._accessNumber, persistentRecords._responsibleRank, persistentRecords._subtreeHoldsWorker, persistentRecords._nodeWorkload, persistentRecords._localWorkload, persistentRecords._totalWorkload, persistentRecords._maxWorkload, persistentRecords._minWorkload, persistentRecords.getCellIsAForkCandidate()) {
assertion((DIMENSIONS+4 < (8 * sizeof(short int))));
...
MPI_Address( const_cast<void*>(static_cast<const void*>(&(dummyCellPacked[1]._persistentRecords._cellIndex))), 		&disp[12] );
...
particles::pit::records::Cell::PersistentRecords::PersistentRecords(const int& cellIndex, const tarch::la::Vector<DIMENSIONS,double>& meanVelocity, const bool& isInside, const State& state, const std::bitset<DIMENSIONS>& evenFlags, const tarch::la::Vector<DIMENSIONS_TIMES_TWO,short int>& accessNumber):
_cellIndex(cellIndex),
_meanVelocity(meanVelocity),
_isInside(isInside),
_state(state),
...
particles::pit::records::Cell::Cell(const PersistentRecords& persistentRecords):
_persistentRecords(persistentRecords._cellIndex, persistentRecords._meanVelocity, persistentRecords._isInside, persistentRecords._state, persistentRecords._evenFlags, persistentRecords._accessNumber) {

}


particles::pit::records::Cell::Cell(const int& cellIndex, const tarch::la::Vector<DIMENSIONS,double>& meanVelocity, const bool& isInside, const State& state, const std::bitset<DIMENSIONS>& evenFlags, const tarch::la::Vector<DIMENSIONS_TIMES_TWO,short int>& accessNumber):
_persistentRecords(cellIndex, meanVelocity, isInside, state, evenFlags, accessNumber) {

}


particles::pit::records::Cell::Cell(const int& cellIndex, const int& numberOfParticlesInChildren, const tarch::la::Vector<DIMENSIONS,double>& meanVelocity, const bool& isInside, const State& state, const std::bitset<DIMENSIONS>& evenFlags, const tarch::la::Vector<DIMENSIONS_TIMES_TWO,short int>& accessNumber):
_persistentRecords(cellIndex, meanVelocity, isInside, state, evenFlags, accessNumber),_numberOfParticlesInChildren(numberOfParticlesInChildren) {
...
MPI_Address( const_cast<void*>(static_cast<const void*>(&(dummyCell[1]._persistentRecords._cellIndex))), 		&disp[7] );
...
particles::pit::records::CellPacked::PersistentRecords::PersistentRecords(const int& cellIndex, const tarch::la::Vector<DIMENSIONS,double>& meanVelocity, const bool& isInside, const State& state, const std::bitset<DIMENSIONS>& evenFlags, const tarch::la::Vector<DIMENSIONS_TIMES_TWO,short int>& accessNumber):
_cellIndex(cellIndex),
_meanVelocity(meanVelocity),
_accessNumber(accessNumber) {
setIsInside(isInside);
...
particles::pit::records::CellPacked::CellPacked(const PersistentRecords& persistentRecords):
_persistentRecords(persistentRecords._cellIndex, persistentRecords._meanVelocity, persistentRecords.getIsInside(), persistentRecords.getState(), persistentRecords.getEvenFlags(), persistentRecords._accessNumber) {
assertion((DIMENSIONS+3 < (8 * sizeof(short int))));

}


particles::pit::records::CellPacked::CellPacked(const int& cellIndex, const tarch::la::Vector<DIMENSIONS,double>& meanVelocity, const bool& isInside, const State& state, const std::bitset<DIMENSIONS>& evenFlags, const tarch::la::Vector<DIMENSIONS_TIMES_TWO,short int>& accessNumber):
_persistentRecords(cellIndex, meanVelocity, isInside, state, evenFlags, accessNumber) {
assertion((DIMENSIONS+3 < (8 * sizeof(short int))));
...
particles::pit::records::CellPacked::CellPacked(const int& cellIndex, const int& numberOfParticlesInChildren, const tarch::la::Vector<DIMENSIONS,double>& meanVelocity, const bool& isInside, const State& state, const std::bitset<DIMENSIONS>& evenFlags, const tarch::la::Vector<DIMENSIONS_TIMES_TWO,short int>& accessNumber):
_persistentRecords(cellIndex, meanVelocity, isInside, state, evenFlags, accessNumber),_numberOfParticlesInChildren(numberOfParticlesInChildren) {
assertion((DIMENSIONS+3 < (8 * sizeof(short int))));
...
MPI_Address( const_cast<void*>(static_cast<const void*>(&(dummyCellPacked[1]._persistentRecords._cellIndex))), 		&disp[5] );
...
particles::pit::records::Cell::Cell(const PersistentRecords& persistentRecords):
_persistentRecords(persistentRecords._cellIndex, persistentRecords._meanVelocity, persistentRecords._isInside, persistentRecords._state, persistentRecords._level, persistentRecords._evenFlags, persistentRecords._accessNumber, persistentRecords._responsibleRank, persistentRecords._subtreeHoldsWorker, persistentRecords._nodeWorkload, persistentRecords._localWorkload, persistentRecords._totalWorkload, persistentRecords._maxWorkload, persistentRecords._minWorkload, persistentRecords._cellIsAForkCandidate, persistentRecords._numberOfLoadsFromInputStream, persistentRecords._numberOfStoresToOutputStream) {

}


particles::pit::records::Cell::Cell(const int& cellIndex, const tarch::la::Vector<DIMENSIONS,double>& meanVelocity, const bool& isInside, const State& state, const int& level, const std::bitset<DIMENSIONS>& evenFlags, const tarch::la::Vector<DIMENSIONS_TIMES_TWO,short int>& accessNumber, const int& responsibleRank, const bool& subtreeHoldsWorker, const double& nodeWorkload, const double& localWorkload, const double& totalWorkload, const double& maxWorkload, const double& minWorkload, const bool& cellIsAForkCandidate, const int& numberOfLoadsFromInputStream, const int& numberOfStoresToOutputStream):
_persistentRecords(cellIndex, meanVelocity, isInside, state, level, evenFlags, accessNumber, responsibleRank, subtreeHoldsWorker, nodeWorkload, localWorkload, totalWorkload, maxWorkload, minWorkload, cellIsAForkCandidate, numberOfLoadsFromInputStream, numberOfStoresToOutputStream) {

}


particles::pit::records::Cell::Cell(const int& cellIndex, const int& numberOfParticlesInChildren, const tarch::la::Vector<DIMENSIONS,double>& meanVelocity, const bool& isInside, const State& state, const int& level, const std::bitset<DIMENSIONS>& evenFlags, const tarch::la::Vector<DIMENSIONS_TIMES_TWO,short int>& accessNumber, const int& responsibleRank, const bool& subtreeHoldsWorker, const double& nodeWorkload, const double& localWorkload, const double& totalWorkload, const double& maxWorkload, const double& minWorkload, const bool& cellIsAForkCandidate, const int& numberOfLoadsFromInputStream, const int& numberOfStoresToOutputStream):
_persistentRecords(cellIndex, meanVelocity, isInside, state, level, evenFlags, accessNumber, responsibleRank, subtreeHoldsWorker, nodeWorkload, localWorkload, totalWorkload, maxWorkload, minWorkload, cellIsAForkCandidate, numberOfLoadsFromInputStream, numberOfStoresToOutputStream),_numberOfParticlesInChildren(numberOfParticlesInChildren) {
...
particles::pit::records::CellPacked::CellPacked(const PersistentRecords& persistentRecords):
_persistentRecords(persistentRecords._cellIndex, persistentRecords._meanVelocity, persistentRecords.getIsInside(), persistentRecords.getState(), persistentRecords._level, persistentRecords.getEvenFlags(), persistentRecords._accessNumber, persistentRecords._responsibleRank, persistentRecords._subtreeHoldsWorker, persistentRecords._nodeWorkload, persistentRecords._localWorkload, persistentRecords._totalWorkload, persistentRecords._maxWorkload, persistentRecords._minWorkload, persistentRecords.getCellIsAForkCandidate(), persistentRecords._numberOfLoadsFromInputStream, persistentRecords._numberOfStoresToOutputStream) {
assertion((DIMENSIONS+4 < (8 * sizeof(short int))));
...
particles::pit::records::Cell::Cell(const int& cellIndex, const tarch::la::Vector<DIMENSIONS,double>& meanVelocity, const bool& isInside, const State& state, const int& level, const std::bitset<DIMENSIONS>& evenFlags, const tarch::la::Vector<DIMENSIONS_TIMES_TWO,short int>& accessNumber, const int& responsibleRank, const bool& subtreeHoldsWorker, const double& nodeWorkload, const double& localWorkload, const double& totalWorkload, const double& maxWorkload, const double& minWorkload, const bool& cellIsAForkCandidate):
_persistentRecords(cellIndex, meanVelocity, isInside, state, level, evenFlags, accessNumber, responsibleRank, subtreeHoldsWorker, nodeWorkload, localWorkload, totalWorkload, maxWorkload, minWorkload, cellIsAForkCandidate) {

}


particles::pit::records::Cell::Cell(const int& cellIndex, const int& numberOfParticlesInChildren, const tarch::la::Vector<DIMENSIONS,double>& meanVelocity, const bool& isInside, const State& state, const int& level, const std::bitset<DIMENSIONS>& evenFlags, const tarch::la::Vector<DIMENSIONS_TIMES_TWO,short int>& accessNumber, const int& responsibleRank, const bool& subtreeHoldsWorker, const double& nodeWorkload, const double& localWorkload, const double& totalWorkload, const double& maxWorkload, const double& minWorkload, const bool& cellIsAForkCandidate):
_persistentRecords(cellIndex, meanVelocity, isInside, state, level, evenFlags, accessNumber, responsibleRank, subtreeHoldsWorker, nodeWorkload, localWorkload, totalWorkload, maxWorkload, minWorkload, cellIsAForkCandidate),_numberOfParticlesInChildren(numberOfParticlesInChildren) {
...
particles::pit::records::Cell::Cell(const int& cellIndex, const tarch::la::Vector<DIMENSIONS,double>& meanVelocity, const bool& isInside, const State& state, const std::bitset<DIMENSIONS>& evenFlags, const tarch::la::Vector<DIMENSIONS_TIMES_TWO,short int>& accessNumber, const int& responsibleRank, const bool& subtreeHoldsWorker, const double& nodeWorkload, const double& localWorkload, const double& totalWorkload, const double& maxWorkload, const double& minWorkload, const bool& cellIsAForkCandidate, const int& numberOfLoadsFromInputStream, const int& numberOfStoresToOutputStream):
_persistentRecords(cellIndex, meanVelocity, isInside, state, evenFlags, accessNumber, responsibleRank, subtreeHoldsWorker, nodeWorkload, localWorkload, totalWorkload, maxWorkload, minWorkload, cellIsAForkCandidate, numberOfLoadsFromInputStream, numberOfStoresToOutputStream) {

}


particles::pit::records::Cell::Cell(const int& cellIndex, const int& numberOfParticlesInChildren, const tarch::la::Vector<DIMENSIONS,double>& meanVelocity, const bool& isInside, const State& state, const std::bitset<DIMENSIONS>& evenFlags, const tarch::la::Vector<DIMENSIONS_TIMES_TWO,short int>& accessNumber, const int& responsibleRank, const bool& subtreeHoldsWorker, const double& nodeWorkload, const double& localWorkload, const double& totalWorkload, const double& maxWorkload, const double& minWorkload, const bool& cellIsAForkCandidate, const int& numberOfLoadsFromInputStream, const int& numberOfStoresToOutputStream):
_persistentRecords(cellIndex, meanVelocity, isInside, state, evenFlags, accessNumber, responsibleRank, subtreeHoldsWorker, nodeWorkload, localWorkload, totalWorkload, maxWorkload, minWorkload, cellIsAForkCandidate, numberOfLoadsFromInputStream, numberOfStoresToOutputStream),_numberOfParticlesInChildren(numberOfParticlesInChildren) {
...
particles::pit::records::Cell::Cell(const PersistentRecords& persistentRecords):
_persistentRecords(persistentRecords._cellIndex, persistentRecords._meanVelocity, persistentRecords._isInside, persistentRecords._state, persistentRecords._level, persistentRecords._evenFlags, persistentRecords._accessNumber, persistentRecords._numberOfLoadsFromInputStream, persistentRecords._numberOfStoresToOutputStream) {

}


particles::pit::records::Cell::Cell(const int& cellIndex, const tarch::la::Vector<DIMENSIONS,double>& meanVelocity, const bool& isInside, const State& state, const int& level, const std::bitset<DIMENSIONS>& evenFlags, const tarch::la::Vector<DIMENSIONS_TIMES_TWO,short int>& accessNumber, const int& numberOfLoadsFromInputStream, const int& numberOfStoresToOutputStream):
_persistentRecords(cellIndex, meanVelocity, isInside, state, level, evenFlags, accessNumber, numberOfLoadsFromInputStream, numberOfStoresToOutputStream) {

}


particles::pit::records::Cell::Cell(const int& cellIndex, const int& numberOfParticlesInChildren, const tarch::la::Vector<DIMENSIONS,double>& meanVelocity, const bool& isInside, const State& state, const int& level, const std::bitset<DIMENSIONS>& evenFlags, const tarch::la::Vector<DIMENSIONS_TIMES_TWO,short int>& accessNumber, const int& numberOfLoadsFromInputStream, const int& numberOfStoresToOutputStream):
_persistentRecords(cellIndex, meanVelocity, isInside, state, level, evenFlags, accessNumber, numberOfLoadsFromInputStream, numberOfStoresToOutputStream),_numberOfParticlesInChildren(numberOfParticlesInChildren) {
