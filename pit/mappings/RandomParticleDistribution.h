...
#ifndef PARTICLES_PIT_MAPPINGS_RandomParticleDistribution_H_
#define PARTICLES_PIT_MAPPINGS_RandomParticleDistribution_H_
 ...
 */
class particles::pit::mappings::RandomParticleDistribution {
  private:
    /**
 ...
 \endcode
     ...
     *
     * @see RandomParticleDistribution()
     */
    void beginIteration(
