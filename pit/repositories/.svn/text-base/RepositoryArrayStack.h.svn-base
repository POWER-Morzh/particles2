...
#ifndef _PARTICLES_PIT_REPOSITORIES_REPOSITORY_ARRAY_STACK_H_ 
#define _PARTICLES_PIT_REPOSITORIES_REPOSITORY_ARRAY_STACK_H_ 
...
class particles::pit::repositories::RepositoryArrayStack: public particles::pit::repositories::Repository {
  private:
    static tarch::logging::Log _log;
  
    peano::geometry::Geometry& _geometry;
    
    typedef peano::stacks::CellArrayStack<particles::pit::Cell>       CellStack;
    typedef peano::stacks::VertexArrayStack<particles::pit::Vertex>   VertexStack;
