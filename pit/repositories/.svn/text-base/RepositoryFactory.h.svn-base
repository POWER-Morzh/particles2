...
#ifndef _PARTICLES_PITREPOSITORIES__REPOSITORY_FACTORY_H_ 
#define _PARTICLES_PITREPOSITORIES__REPOSITORY_FACTORY_H_
 ...
 */
class particles::pit::repositories::RepositoryFactory {
  private:
    RepositoryFactory();
  public:
