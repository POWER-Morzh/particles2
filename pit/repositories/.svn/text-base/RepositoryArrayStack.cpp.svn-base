...
tarch::logging::Log particles::pit::repositories::RepositoryArrayStack::_log( "particles::pit::repositories::RepositoryArrayStack" );


particles::pit::repositories::RepositoryArrayStack::RepositoryArrayStack(
...
void particles::pit::repositories::RepositoryArrayStack::restart(
  const tarch::la::Vector<DIMENSIONS,double>&  domainSize,
  const tarch::la::Vector<DIMENSIONS,double>&  domainOffset,
  int                                          domainLevel,
...
void particles::pit::repositories::RepositoryArrayStack::terminate() {
...
particles::pit::State& particles::pit::repositories::RepositoryArrayStack::getState() {
  return _solverState;
}


const particles::pit::State& particles::pit::repositories::RepositoryArrayStack::getState() const {
  return _solverState;
}

   
void particles::pit::repositories::RepositoryArrayStack::iterate() {
  tarch::timing::Watch watch( "particles::pit::repositories::RepositoryArrayStack", "iterate(bool)", false);
 ...
 void particles::pit::repositories::RepositoryArrayStack::switchToNop() { _repositoryState.setAction(particles::pit::records::RepositoryState::UseAdapterNop); }
 void particles::pit::repositories::RepositoryArrayStack::switchToInitGrid() { _repositoryState.setAction(particles::pit::records::RepositoryState::UseAdapterInitGrid); }
 void particles::pit::repositories::RepositoryArrayStack::switchToInitGridAndPlot() { _repositoryState.setAction(particles::pit::records::RepositoryState::UseAdapterInitGridAndPlot); }
 void particles::pit::repositories::RepositoryArrayStack::switchToSetupExperimentWithRandomParticleDistribution() { _repositoryState.setAction(particles::pit::records::RepositoryState::UseAdapterSetupExperimentWithRandomParticleDistribution); }
 void particles::pit::repositories::RepositoryArrayStack::switchToSetupExperimentWithRandomParticleDistributionAndPlot() { _repositoryState.setAction(particles::pit::records::RepositoryState::UseAdapterSetupExperimentWithRandomParticleDistributionAndPlot); }
 void particles::pit::repositories::RepositoryArrayStack::switchToMoveParticles() { _repositoryState.setAction(particles::pit::records::RepositoryState::UseAdapterMoveParticles); }
 void particles::pit::repositories::RepositoryArrayStack::switchToMoveParticlesAndPlot() { _repositoryState.setAction(particles::pit::records::RepositoryState::UseAdapterMoveParticlesAndPlot); }



 bool particles::pit::repositories::RepositoryArrayStack::isActiveAdapterNop() const { return _repositoryState.getAction() == particles::pit::records::RepositoryState::UseAdapterNop; }
 bool particles::pit::repositories::RepositoryArrayStack::isActiveAdapterInitGrid() const { return _repositoryState.getAction() == particles::pit::records::RepositoryState::UseAdapterInitGrid; }
 bool particles::pit::repositories::RepositoryArrayStack::isActiveAdapterInitGridAndPlot() const { return _repositoryState.getAction() == particles::pit::records::RepositoryState::UseAdapterInitGridAndPlot; }
 bool particles::pit::repositories::RepositoryArrayStack::isActiveAdapterSetupExperimentWithRandomParticleDistribution() const { return _repositoryState.getAction() == particles::pit::records::RepositoryState::UseAdapterSetupExperimentWithRandomParticleDistribution; }
 bool particles::pit::repositories::RepositoryArrayStack::isActiveAdapterSetupExperimentWithRandomParticleDistributionAndPlot() const { return _repositoryState.getAction() == particles::pit::records::RepositoryState::UseAdapterSetupExperimentWithRandomParticleDistributionAndPlot; }
 bool particles::pit::repositories::RepositoryArrayStack::isActiveAdapterMoveParticles() const { return _repositoryState.getAction() == particles::pit::records::RepositoryState::UseAdapterMoveParticles; }
 bool particles::pit::repositories::RepositoryArrayStack::isActiveAdapterMoveParticlesAndPlot() const { return _repositoryState.getAction() == particles::pit::records::RepositoryState::UseAdapterMoveParticlesAndPlot; }



peano::grid::Checkpoint<particles::pit::Vertex, particles::pit::Cell>* particles::pit::repositories::RepositoryArrayStack::createEmptyCheckpoint() {
  return new peano::grid::Checkpoint<particles::pit::Vertex, particles::pit::Cell>();
} 


void particles::pit::repositories::RepositoryArrayStack::writeCheckpoint(peano::grid::Checkpoint<particles::pit::Vertex, particles::pit::Cell> * const checkpoint) {
...
void particles::pit::repositories::RepositoryArrayStack::setMaximumMemoryFootprintForTemporaryRegularGrids(double value) {
  _regularGridContainer.setMaximumMemoryFootprintForTemporaryRegularGrids(value);
}


void particles::pit::repositories::RepositoryArrayStack::readCheckpoint( peano::grid::Checkpoint<particles::pit::Vertex, particles::pit::Cell> const * const checkpoint ) {
...
#ifdef Parallel
void particles::pit::repositories::RepositoryArrayStack::runGlobalStep() {
  assertion(tarch::parallel::Node::getInstance().isGlobalMaster());
...
particles::pit::repositories::RepositoryArrayStack::ContinueCommand particles::pit::repositories::RepositoryArrayStack::continueToIterate() {
...
void particles::pit::repositories::RepositoryArrayStack::logIterationStatistics() const {
...
void particles::pit::repositories::RepositoryArrayStack::clearIterationStatistics() {
