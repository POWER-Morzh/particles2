...
#ifndef PARTICLES_PIT_ADAPTERS_MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1_H_
#define PARTICLES_PIT_ADAPTERS_MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1_H_
 ...
 */
class particles::pit::adapters::MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1 {
  private:
    struct LevelDataset {
      /**
