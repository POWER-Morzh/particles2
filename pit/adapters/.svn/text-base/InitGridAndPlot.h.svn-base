...
#ifndef PARTICLES_PIT_ADAPTERS_InitGridAndPlot_H_
#define PARTICLES_PIT_ADAPTERS_InitGridAndPlot_H_
 ...
 */
class particles::pit::adapters::InitGridAndPlot {
  private:
    particles::pit::mappings::InitGrid _map2InitGrid;

    particles::pit::adapters::InitGridAndPlot2VTKMultilevelGridVisualiser_0 _map2InitGridAndPlot2VTKMultilevelGridVisualiser_0;
    particles::pit::adapters::InitGridAndPlot2VTKGridVisualiser_1 _map2InitGridAndPlot2VTKGridVisualiser_1;
  ...
  public:
    ...
    InitGridAndPlot(const InitGridAndPlot& masterThread);
    #endif

    virtual ~InitGridAndPlot();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const InitGridAndPlot& workerThread);
    #endif
