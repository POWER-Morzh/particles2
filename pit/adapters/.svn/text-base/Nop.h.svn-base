...
#ifndef PARTICLES_PIT_ADAPTERS_Nop_H_
#define PARTICLES_PIT_ADAPTERS_Nop_H_
...
#include "particles/pit/State.h"
 ...
 #include "particles/pit/mappings/Nop.h"
 ...
 */
class particles::pit::adapters::Nop {
  private:
    particles::pit::mappings::Nop _map2Nop;
