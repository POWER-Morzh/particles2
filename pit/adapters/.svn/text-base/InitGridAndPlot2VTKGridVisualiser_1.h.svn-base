...
#ifndef PARTICLES_PIT_ADAPTERS_InitGridAndPlot2VTKGridVisualiser_1_H_
#define PARTICLES_PIT_ADAPTERS_InitGridAndPlot2VTKGridVisualiser_1_H_
 ...
 */
class particles::pit::adapters::InitGridAndPlot2VTKGridVisualiser_1 {
  private:
    /**
