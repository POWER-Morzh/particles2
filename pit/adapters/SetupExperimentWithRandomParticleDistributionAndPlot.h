...
#ifndef PARTICLES_PIT_ADAPTERS_SetupExperimentWithRandomParticleDistributionAndPlot_H_
#define PARTICLES_PIT_ADAPTERS_SetupExperimentWithRandomParticleDistributionAndPlot_H_
...
namespace particles { 
  namespace pit {
      namespace adapters {
        class SetupExperimentWithRandomParticleDistributionAndPlot;
      } 
}
}
 ...
 */
class particles::pit::adapters::SetupExperimentWithRandomParticleDistributionAndPlot {
  private:
    particles::pit::mappings::RandomParticleDistribution _map2RandomParticleDistribution;
    particles::pit::mappings::InitGrid _map2InitGrid;
    particles::pit::mappings::PlotParticles _map2PlotParticles;
    particles::pit::mappings::Redistribute _map2Redistribute;

    particles::pit::adapters::SetupExperimentWithRandomParticleDistributionAndPlot2VTKGridVisualiser_0 _map2SetupExperimentWithRandomParticleDistributionAndPlot2VTKGridVisualiser_0;
    particles::pit::adapters::SetupExperimentWithRandomParticleDistributionAndPlot2VTKMultilevelGridVisualiser_1 _map2SetupExperimentWithRandomParticleDistributionAndPlot2VTKMultilevelGridVisualiser_1;
  ...
  public:
    ...
    SetupExperimentWithRandomParticleDistributionAndPlot();

    #if defined(SharedMemoryParallelisation)
    SetupExperimentWithRandomParticleDistributionAndPlot(const SetupExperimentWithRandomParticleDistributionAndPlot& masterThread);
    #endif

    virtual ~SetupExperimentWithRandomParticleDistributionAndPlot();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const SetupExperimentWithRandomParticleDistributionAndPlot& workerThread);
    #endif
