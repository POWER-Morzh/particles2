...
#ifndef PARTICLES_PIT_ADAPTERS_SetupExperimentWithRandomParticleDistributionAndPlot2VTKMultilevelGridVisualiser_1_H_
#define PARTICLES_PIT_ADAPTERS_SetupExperimentWithRandomParticleDistributionAndPlot2VTKMultilevelGridVisualiser_1_H_
 ...
 */
class particles::pit::adapters::SetupExperimentWithRandomParticleDistributionAndPlot2VTKMultilevelGridVisualiser_1 {
  private:
    struct LevelDataset {
      /**
