...
#ifndef PARTICLES_PIDT_ADAPTERS_InitGridAndPlot2VTKGridVisualiser_1_H_
#define PARTICLES_PIDT_ADAPTERS_InitGridAndPlot2VTKGridVisualiser_1_H_
...
namespace particles { 
  namespace pidt {
      namespace adapters {
        class InitGridAndPlot2VTKGridVisualiser_1;
      } 
}
}
 ...
 */
class particles::pidt::adapters::InitGridAndPlot2VTKGridVisualiser_1 {
  private:
    /**
  ...
  public:
    ...
    InitGridAndPlot2VTKGridVisualiser_1();

    #if defined(SharedMemoryParallelisation)
    InitGridAndPlot2VTKGridVisualiser_1(const InitGridAndPlot2VTKGridVisualiser_1& masterThread);
    #endif

    virtual ~InitGridAndPlot2VTKGridVisualiser_1();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const InitGridAndPlot2VTKGridVisualiser_1& workerThread);
    #endif
