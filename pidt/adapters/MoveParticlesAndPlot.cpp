...
peano::MappingSpecification   particles::pidt::adapters::MoveParticlesAndPlot::touchVertexLastTimeSpecification() {
  return peano::MappingSpecification::getMostGeneralSpecification()
   ...
   & particles::pidt::adapters::MoveParticlesAndPlot2VTKGridVisualiser_0::touchVertexLastTimeSpecification()
   & particles::pidt::adapters::MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1::touchVertexLastTimeSpecification()

;
}


peano::MappingSpecification   particles::pidt::adapters::MoveParticlesAndPlot::touchVertexFirstTimeSpecification() { 
  return peano::MappingSpecification::getMostGeneralSpecification()
   ...
   & particles::pidt::adapters::MoveParticlesAndPlot2VTKGridVisualiser_0::touchVertexFirstTimeSpecification()
   & particles::pidt::adapters::MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1::touchVertexFirstTimeSpecification()

;
}


peano::MappingSpecification   particles::pidt::adapters::MoveParticlesAndPlot::enterCellSpecification() {
  return peano::MappingSpecification::getMostGeneralSpecification()
   ...
   & particles::pidt::adapters::MoveParticlesAndPlot2VTKGridVisualiser_0::enterCellSpecification()
   & particles::pidt::adapters::MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1::enterCellSpecification()

;
}


peano::MappingSpecification   particles::pidt::adapters::MoveParticlesAndPlot::leaveCellSpecification() {
  return peano::MappingSpecification::getMostGeneralSpecification()
   ...
   & particles::pidt::adapters::MoveParticlesAndPlot2VTKGridVisualiser_0::leaveCellSpecification()
   & particles::pidt::adapters::MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1::leaveCellSpecification()

;
}


peano::MappingSpecification   particles::pidt::adapters::MoveParticlesAndPlot::ascendSpecification() {
  return peano::MappingSpecification::getMostGeneralSpecification()
   ...
   & particles::pidt::adapters::MoveParticlesAndPlot2VTKGridVisualiser_0::ascendSpecification()
   & particles::pidt::adapters::MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1::ascendSpecification()

;
}


peano::MappingSpecification   particles::pidt::adapters::MoveParticlesAndPlot::descendSpecification() {
  return peano::MappingSpecification::getMostGeneralSpecification()
   ...
   & particles::pidt::adapters::MoveParticlesAndPlot2VTKGridVisualiser_0::descendSpecification()
   & particles::pidt::adapters::MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1::descendSpecification()

;
}


particles::pidt::adapters::MoveParticlesAndPlot::MoveParticlesAndPlot() {
}
...
particles::pidt::adapters::MoveParticlesAndPlot::MoveParticlesAndPlot(const MoveParticlesAndPlot&  masterThread):
...
void particles::pidt::adapters::MoveParticlesAndPlot::mergeWithWorkerThread(const MoveParticlesAndPlot& workerThread) {
...
void particles::pidt::adapters::MoveParticlesAndPlot::createHangingVertex(
...
void particles::pidt::adapters::MoveParticlesAndPlot::destroyHangingVertex(
...
void particles::pidt::adapters::MoveParticlesAndPlot::createInnerVertex(
      particles::pidt::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      particles::pidt::Vertex * const        coarseGridVertices,
...
void particles::pidt::adapters::MoveParticlesAndPlot::createBoundaryVertex(
      particles::pidt::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      particles::pidt::Vertex * const        coarseGridVertices,
...
void particles::pidt::adapters::MoveParticlesAndPlot::destroyVertex(
      const particles::pidt::Vertex&   fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      particles::pidt::Vertex * const  coarseGridVertices,
...
void particles::pidt::adapters::MoveParticlesAndPlot::createCell(
...
void particles::pidt::adapters::MoveParticlesAndPlot::destroyCell(
...
#ifdef Parallel
void particles::pidt::adapters::MoveParticlesAndPlot::mergeWithNeighbour(
...
void particles::pidt::adapters::MoveParticlesAndPlot::prepareSendToNeighbour(
  particles::pidt::Vertex&  vertex,
  int                                           toRank,
...
void particles::pidt::adapters::MoveParticlesAndPlot::prepareCopyToRemoteNode(
...
void particles::pidt::adapters::MoveParticlesAndPlot::mergeWithRemoteDataDueToForkOrJoin(
  particles::pidt::Vertex&  localVertex,
...
bool particles::pidt::adapters::MoveParticlesAndPlot::prepareSendToWorker(
  particles::pidt::Cell&                 fineGridCell,
  particles::pidt::Vertex * const        fineGridVertices,
  const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
  particles::pidt::Vertex * const        coarseGridVertices,
...
void particles::pidt::adapters::MoveParticlesAndPlot::prepareSendToMaster(
  particles::pidt::Cell&                       localCell,
...
void particles::pidt::adapters::MoveParticlesAndPlot::mergeWithMaster(
...
void particles::pidt::adapters::MoveParticlesAndPlot::receiveDataFromMaster(
...
void particles::pidt::adapters::MoveParticlesAndPlot::mergeWithWorker(
  particles::pidt::Cell&           localCell, 
...
void particles::pidt::adapters::MoveParticlesAndPlot::touchVertexFirstTime(
      particles::pidt::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      particles::pidt::Vertex * const        coarseGridVertices,
...
void particles::pidt::adapters::MoveParticlesAndPlot::touchVertexLastTime(
      particles::pidt::Vertex&         fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      particles::pidt::Vertex * const  coarseGridVertices,
...
void particles::pidt::adapters::MoveParticlesAndPlot::enterCell(
      particles::pidt::Cell&                 fineGridCell,
      particles::pidt::Vertex * const        fineGridVertices,
      const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
      particles::pidt::Vertex * const        coarseGridVertices,
...
void particles::pidt::adapters::MoveParticlesAndPlot::leaveCell(
      particles::pidt::Cell&           fineGridCell,
      particles::pidt::Vertex * const  fineGridVertices,
      const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
      particles::pidt::Vertex * const  coarseGridVertices,
...
void particles::pidt::adapters::MoveParticlesAndPlot::beginIteration(
...
void particles::pidt::adapters::MoveParticlesAndPlot::endIteration(
  particles::pidt::State&  solverState
) {
...
void particles::pidt::adapters::MoveParticlesAndPlot::descend(
...
void particles::pidt::adapters::MoveParticlesAndPlot::ascend(
  particles::pidt::Cell * const    fineGridCells,
  particles::pidt::Vertex * const  fineGridVertices,
  const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
  particles::pidt::Vertex * const  coarseGridVertices,
