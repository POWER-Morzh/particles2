...
#ifndef PARTICLES_PIDT_ADAPTERS_Nop_H_
#define PARTICLES_PIDT_ADAPTERS_Nop_H_
...
#include "particles/pidt/State.h"
 ...
 #include "particles/pidt/mappings/Nop.h"
 ...
 */
class particles::pidt::adapters::Nop {
  private:
    particles::pidt::mappings::Nop _map2Nop;
  ...
  public:
    ...
    Nop(const Nop& masterThread);
    #endif

    virtual ~Nop();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const Nop& workerThread);
    #endif
