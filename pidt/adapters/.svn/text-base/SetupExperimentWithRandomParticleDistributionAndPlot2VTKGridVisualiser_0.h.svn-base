...
#ifndef PARTICLES_PIDT_ADAPTERS_SetupExperimentWithRandomParticleDistributionAndPlot2VTKGridVisualiser_0_H_
#define PARTICLES_PIDT_ADAPTERS_SetupExperimentWithRandomParticleDistributionAndPlot2VTKGridVisualiser_0_H_
...
namespace particles { 
  namespace pidt {
      namespace adapters {
        class SetupExperimentWithRandomParticleDistributionAndPlot2VTKGridVisualiser_0;
      } 
}
}
 ...
 */
class particles::pidt::adapters::SetupExperimentWithRandomParticleDistributionAndPlot2VTKGridVisualiser_0 {
  private:
    /**
  ...
  public:
    ...
    SetupExperimentWithRandomParticleDistributionAndPlot2VTKGridVisualiser_0();

    #if defined(SharedMemoryParallelisation)
    SetupExperimentWithRandomParticleDistributionAndPlot2VTKGridVisualiser_0(const SetupExperimentWithRandomParticleDistributionAndPlot2VTKGridVisualiser_0& masterThread);
    #endif

    virtual ~SetupExperimentWithRandomParticleDistributionAndPlot2VTKGridVisualiser_0();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const SetupExperimentWithRandomParticleDistributionAndPlot2VTKGridVisualiser_0& workerThread);
    #endif
