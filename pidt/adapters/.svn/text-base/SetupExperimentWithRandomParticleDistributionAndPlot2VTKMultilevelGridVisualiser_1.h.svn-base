...
#ifndef PARTICLES_PIDT_ADAPTERS_SetupExperimentWithRandomParticleDistributionAndPlot2VTKMultilevelGridVisualiser_1_H_
#define PARTICLES_PIDT_ADAPTERS_SetupExperimentWithRandomParticleDistributionAndPlot2VTKMultilevelGridVisualiser_1_H_
...
namespace particles { 
  namespace pidt {
      namespace adapters {
        class SetupExperimentWithRandomParticleDistributionAndPlot2VTKMultilevelGridVisualiser_1;
      } 
}
}
 ...
 *
 * multilevelstartgrid   filename
 *
 * @author Tobias Weinzierl
 * @version $Revision: 1.10 $
 */
class particles::pidt::adapters::SetupExperimentWithRandomParticleDistributionAndPlot2VTKMultilevelGridVisualiser_1 {
  private:
    struct LevelDataset {
      /**
  ...
  public:
    ...
    SetupExperimentWithRandomParticleDistributionAndPlot2VTKMultilevelGridVisualiser_1();

    #if defined(SharedMemoryParallelisation)
    SetupExperimentWithRandomParticleDistributionAndPlot2VTKMultilevelGridVisualiser_1(const SetupExperimentWithRandomParticleDistributionAndPlot2VTKMultilevelGridVisualiser_1& masterThread);
    #endif

    virtual ~SetupExperimentWithRandomParticleDistributionAndPlot2VTKMultilevelGridVisualiser_1();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const SetupExperimentWithRandomParticleDistributionAndPlot2VTKMultilevelGridVisualiser_1& workerThread);
    #endif
