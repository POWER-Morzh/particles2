...
#ifndef PARTICLES_PIDT_ADAPTERS_InitGridAndPlot_H_
#define PARTICLES_PIDT_ADAPTERS_InitGridAndPlot_H_
 ...
 */
class particles::pidt::adapters::InitGridAndPlot {
  private:
    particles::pidt::mappings::InitGrid _map2InitGrid;

    particles::pidt::adapters::InitGridAndPlot2VTKMultilevelGridVisualiser_0 _map2InitGridAndPlot2VTKMultilevelGridVisualiser_0;
    particles::pidt::adapters::InitGridAndPlot2VTKGridVisualiser_1 _map2InitGridAndPlot2VTKGridVisualiser_1;
