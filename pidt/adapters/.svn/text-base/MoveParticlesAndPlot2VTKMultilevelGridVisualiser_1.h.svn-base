...
#ifndef PARTICLES_PIDT_ADAPTERS_MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1_H_
#define PARTICLES_PIDT_ADAPTERS_MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1_H_
...
namespace particles { 
  namespace pidt {
      namespace adapters {
        class MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1;
      } 
}
}
 ...
 *
 * multilevelgrid   filename
 *
 * @author Tobias Weinzierl
 * @version $Revision: 1.10 $
 */
class particles::pidt::adapters::MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1 {
  private:
    struct LevelDataset {
      /**
  ...
  public:
    ...
    MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1();

    #if defined(SharedMemoryParallelisation)
    MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1(const MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1& masterThread);
    #endif

    virtual ~MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1& workerThread);
    #endif
