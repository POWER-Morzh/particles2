...
int particles::pidt::adapters::MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1::_snapshotCounter = 0;


std::map<int,particles::pidt::adapters::MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1::LevelDataset>  particles::pidt::adapters::MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1::_dataset;


peano::MappingSpecification   particles::pidt::adapters::MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1::touchVertexLastTimeSpecification() {
  return peano::MappingSpecification(peano::MappingSpecification::Nop,peano::MappingSpecification::RunConcurrentlyOnFineGrid,true);
}


peano::MappingSpecification   particles::pidt::adapters::MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1::touchVertexFirstTimeSpecification() { 
  return peano::MappingSpecification(peano::MappingSpecification::WholeTree,peano::MappingSpecification::Serial,false);
}


peano::MappingSpecification   particles::pidt::adapters::MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1::enterCellSpecification() {
  return peano::MappingSpecification(peano::MappingSpecification::Nop,peano::MappingSpecification::AvoidFineGridRaces,true);
}


peano::MappingSpecification   particles::pidt::adapters::MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1::leaveCellSpecification() {
...
peano::MappingSpecification   particles::pidt::adapters::MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1::ascendSpecification() {
  return peano::MappingSpecification(peano::MappingSpecification::Nop,peano::MappingSpecification::RunConcurrentlyOnFineGrid,true);
}


peano::MappingSpecification   particles::pidt::adapters::MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1::descendSpecification() {
  return peano::MappingSpecification(peano::MappingSpecification::Nop,peano::MappingSpecification::RunConcurrentlyOnFineGrid,true);
}


particles::pidt::adapters::MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1::MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1::LevelDataset::LevelDataset():
  _vtkWriter(0),
  _vertexWriter(0),
  _cellWriter(0),
  _vertexTypeWriter(0),
...
void particles::pidt::adapters::MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1::LevelDataset::close(const std::string& filename) {
  assertion( _vertexWriter != 0 );
  assertion( _cellWriter != 0 );
  assertion( _vertexTypeWriter != 0 );
  assertion( _vertexRefinementControlWriter != 0 );
...
particles::pidt::adapters::MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1::MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1() {
}
...
particles::pidt::adapters::MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1::MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1(const MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1&  masterThread) {
}


void particles::pidt::adapters::MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1::mergeWithWorkerThread(const MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1& workerThread) {
}
#endif


void particles::pidt::adapters::MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1::plotVertex(
...
void particles::pidt::adapters::MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1::createHangingVertex(
...
void particles::pidt::adapters::MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1::destroyHangingVertex(
      const particles::pidt::Vertex&   fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      particles::pidt::Vertex * const  coarseGridVertices,
...
void particles::pidt::adapters::MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1::createInnerVertex(
      particles::pidt::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      particles::pidt::Vertex * const        coarseGridVertices,
...
void particles::pidt::adapters::MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1::createBoundaryVertex(
      particles::pidt::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      particles::pidt::Vertex * const        coarseGridVertices,
...
void particles::pidt::adapters::MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1::destroyVertex(
      const particles::pidt::Vertex&   fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      particles::pidt::Vertex * const  coarseGridVertices,
...
void particles::pidt::adapters::MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1::createCell(
...
void particles::pidt::adapters::MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1::destroyCell(
...
#ifdef Parallel
void particles::pidt::adapters::MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1::mergeWithNeighbour(
...
void particles::pidt::adapters::MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1::prepareSendToNeighbour(
      particles::pidt::Vertex&  vertex,
      int                                           toRank,
...
void particles::pidt::adapters::MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1::prepareCopyToRemoteNode(
...
void particles::pidt::adapters::MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1::mergeWithRemoteDataDueToForkOrJoin(
  particles::pidt::Vertex&  localVertex,
...
bool particles::pidt::adapters::MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1::prepareSendToWorker(
  particles::pidt::Cell&                 fineGridCell,
  particles::pidt::Vertex * const        fineGridVertices,
  const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
  particles::pidt::Vertex * const        coarseGridVertices,
...
void particles::pidt::adapters::MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1::prepareSendToMaster(
      particles::pidt::Cell&                       localCell,
...
void particles::pidt::adapters::MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1::mergeWithMaster(
...
void particles::pidt::adapters::MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1::receiveDataFromMaster(
...
void particles::pidt::adapters::MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1::mergeWithWorker(
      particles::pidt::Cell&           localCell, 
...
void particles::pidt::adapters::MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1::touchVertexFirstTime(
      particles::pidt::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      particles::pidt::Vertex * const        coarseGridVertices,
...
void particles::pidt::adapters::MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1::touchVertexLastTime(
      particles::pidt::Vertex&         fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      particles::pidt::Vertex * const  coarseGridVertices,
...
void particles::pidt::adapters::MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1::enterCell(
      particles::pidt::Cell&                 fineGridCell,
      particles::pidt::Vertex * const        fineGridVertices,
      const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
      particles::pidt::Vertex * const        coarseGridVertices,
...
void particles::pidt::adapters::MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1::leaveCell(
      particles::pidt::Cell&           fineGridCell,
      particles::pidt::Vertex * const  fineGridVertices,
      const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
      particles::pidt::Vertex * const  coarseGridVertices,
...
void particles::pidt::adapters::MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1::beginIteration(
...
void particles::pidt::adapters::MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1::endIteration(
  particles::pidt::State&  solverState
) {
...
void particles::pidt::adapters::MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1::descend(
...
void particles::pidt::adapters::MoveParticlesAndPlot2VTKMultilevelGridVisualiser_1::ascend(
  particles::pidt::Cell * const    fineGridCells,
  particles::pidt::Vertex * const  fineGridVertices,
  const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
  particles::pidt::Vertex * const  coarseGridVertices,
