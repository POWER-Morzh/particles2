...
#ifndef _PARTICLES_PIDT_REPOSITORIES_REPOSITORY_ARRAY_STACK_H_ 
#define _PARTICLES_PIDT_REPOSITORIES_REPOSITORY_ARRAY_STACK_H_ 
...
class particles::pidt::repositories::RepositoryArrayStack: public particles::pidt::repositories::Repository {
  private:
    static tarch::logging::Log _log;
  
    peano::geometry::Geometry& _geometry;
    
    typedef peano::stacks::CellArrayStack<particles::pidt::Cell>       CellStack;
    typedef peano::stacks::VertexArrayStack<particles::pidt::Vertex>   VertexStack;
