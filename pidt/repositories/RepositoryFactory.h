...
#ifndef _PARTICLES_PIDTREPOSITORIES__REPOSITORY_FACTORY_H_ 
#define _PARTICLES_PIDTREPOSITORIES__REPOSITORY_FACTORY_H_
 ...
 */
class particles::pidt::repositories::RepositoryFactory {
  private:
    RepositoryFactory();
  public:
