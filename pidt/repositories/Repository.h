...
#ifndef _PARTICLES_PIDTREPOSITORIES__REPOSITORY_H_ 
#define _PARTICLES_PIDTREPOSITORIES__REPOSITORY_H_
 ...
 */
class particles::pidt::repositories::Repository {
  public:
    virtual ~Repository() {};
    ...
    virtual particles::pidt::State& getState() = 0;
    virtual const particles::pidt::State& getState() const = 0;
     ...
     */
    virtual void writeCheckpoint(peano::grid::Checkpoint<particles::pidt::Vertex,particles::pidt::Cell> * const checkpoint) = 0; 
     ...
     */
    virtual void readCheckpoint( peano::grid::Checkpoint<particles::pidt::Vertex,particles::pidt::Cell> const * const checkpoint ) = 0;
     ...
     * - Destroy the checkpoint object on the heap. 
     */
    virtual peano::grid::Checkpoint<particles::pidt::Vertex,particles::pidt::Cell>* createEmptyCheckpoint() = 0;
