#ifndef _PARTICLES_PIDT_RECORDS_REPOSITORYSTATE_H
#define _PARTICLES_PIDT_RECORDS_REPOSITORYSTATE_H
 ...
 */
class particles::pidt::records::RepositoryState { 
   
   public:
      
      typedef particles::pidt::records::RepositoryStatePacked Packed;
 ...
 #endif 
 {
    ...
    * @date   06/02/2014 16:27
    */
   class particles::pidt::records::RepositoryStatePacked { 
      
      public:
         
         typedef particles::pidt::records::RepositoryState::Action Action;
