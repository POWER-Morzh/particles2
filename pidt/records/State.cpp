#include "particles/pidt/records/State.h"
   ...
   particles::pidt::records::State::State() {
      
   }
   
   
   particles::pidt::records::State::State(const PersistentRecords& persistentRecords):
   ...
   std::string particles::pidt::records::State::toString() const {
      std::ostringstream stringstr;
      toString(stringstr);
      return stringstr.str();
   }
   
   void particles::pidt::records::State::toString (std::ostream& out) const {
      out << "("; 
   ...
   particles::pidt::records::State::PersistentRecords particles::pidt::records::State::getPersistentRecords() const {
      return _persistentRecords;
   }
   
   particles::pidt::records::StatePacked particles::pidt::records::State::convert() const{
      return StatePacked(
   ...
   #ifdef Parallel
      tarch::logging::Log particles::pidt::records::State::_log( "particles::pidt::records::State" );
      
      MPI_Datatype particles::pidt::records::State::Datatype = 0;
      MPI_Datatype particles::pidt::records::State::FullDatatype = 0;
      
      
      void particles::pidt::records::State::initDatatype() {
         {
            State dummyState[2];
      ...
      void particles::pidt::records::State::shutdownDatatype() {
         MPI_Type_free( &State::Datatype );
         MPI_Type_free( &State::FullDatatype );
         
      }
      
      void particles::pidt::records::State::send(int destination, int tag, bool exchangeOnlyAttributesMarkedWithParallelise, bool communicateBlocking) {
         ...
         if (communicateBlocking) {
            ...
            if  (result!=MPI_SUCCESS) {
               ...
               msg << "was not able to send message particles::pidt::records::State "
               << toString()
               << " to node " << destination
         ...
         while (!flag) {
            ...
            if (result!=MPI_SUCCESS) {
               std::ostringstream msg;
               msg << "testing for finished send task for particles::pidt::records::State "
               << toString()
   ...
   void particles::pidt::records::State::receive(int source, int tag, bool exchangeOnlyAttributesMarkedWithParallelise, bool communicateBlocking) {
      if (communicateBlocking) {
         ...
         if ( result != MPI_SUCCESS ) {
            std::ostringstream msg;
            msg << "failed to start to receive particles::pidt::records::State from node "
         ...
         while (!flag) {
            ...
            if (result!=MPI_SUCCESS) {
               std::ostringstream msg;
               msg << "testing for finished receive task for particles::pidt::records::State failed: "
               << tarch::parallel::MPIReturnValueToString(result);
               _log.error("receive(int)", msg.str() );
            }
   ...
   bool particles::pidt::records::State::isMessageInQueue(int tag, bool exchangeOnlyAttributesMarkedWithParallelise) {
      MPI_Status status;
      int  flag        = 0;
      MPI_Iprobe(
         MPI_ANY_SOURCE, tag,
   ...
   int particles::pidt::records::State::getSenderRank() const {
...
particles::pidt::records::StatePacked::PersistentRecords::PersistentRecords() {
...
particles::pidt::records::StatePacked::StatePacked() {
   assertion((8 < (8 * sizeof(short int))));
   
}


particles::pidt::records::StatePacked::StatePacked(const PersistentRecords& persistentRecords):
...
particles::pidt::records::StatePacked::StatePacked(const int& minimalNumberOfParticlesPerCell, const double& timeStepSize, const double& maximalNumberOfInitialParticlesPerUnitVolume, const double& maximalInitialVelocity, const double& breakingDamWidth, const double& numberOfLifts, const double& numberOfParticlesInLeaves, const tarch::la::Vector<MaxLevels,double>& liftsPerLevel, const double& accumulatedDensity, const double& nonEmptyLeaves, const double& particlesSentToMaster, const tarch::la::Vector<DIMENSIONS,double>& minMeshWidth, const tarch::la::Vector<DIMENSIONS,double>& maxMeshWidth, const double& numberOfInnerVertices, const double& numberOfBoundaryVertices, const double& numberOfOuterVertices, const double& numberOfInnerCells, const double& numberOfOuterCells, const double& numberOfInnerLeafVertices, const double& numberOfBoundaryLeafVertices, const double& numberOfOuterLeafVertices, const double& numberOfInnerLeafCells, const double& numberOfOuterLeafCells, const int& maxLevel, const bool& hasRefined, const bool& hasTriggeredRefinementForNextIteration, const bool& hasErased, const bool& hasTriggeredEraseForNextIteration, const bool& hasChangedVertexOrCellState, const bool& isTraversalInverted, const bool& reduceStateAndCell, const bool& couldNotEraseDueToDecompositionFlag, const bool& subWorkerIsInvolvedInJoinOrFork):
_persistentRecords(minimalNumberOfParticlesPerCell, timeStepSize, maximalNumberOfInitialParticlesPerUnitVolume, maximalInitialVelocity, breakingDamWidth, numberOfLifts, numberOfParticlesInLeaves, liftsPerLevel, accumulatedDensity, nonEmptyLeaves, particlesSentToMaster, minMeshWidth, maxMeshWidth, numberOfInnerVertices, numberOfBoundaryVertices, numberOfOuterVertices, numberOfInnerCells, numberOfOuterCells, numberOfInnerLeafVertices, numberOfBoundaryLeafVertices, numberOfOuterLeafVertices, numberOfInnerLeafCells, numberOfOuterLeafCells, maxLevel, hasRefined, hasTriggeredRefinementForNextIteration, hasErased, hasTriggeredEraseForNextIteration, hasChangedVertexOrCellState, isTraversalInverted, reduceStateAndCell, couldNotEraseDueToDecompositionFlag, subWorkerIsInvolvedInJoinOrFork) {
   assertion((8 < (8 * sizeof(short int))));
...
std::string particles::pidt::records::StatePacked::toString() const {
   std::ostringstream stringstr;
   toString(stringstr);
   return stringstr.str();
}

void particles::pidt::records::StatePacked::toString (std::ostream& out) const {
   out << "("; 
   out << "minimalNumberOfParticlesPerCell:" << getMinimalNumberOfParticlesPerCell();
   out << ",";
   out << "timeStepSize:" << getTimeStepSize();
...
particles::pidt::records::StatePacked::PersistentRecords particles::pidt::records::StatePacked::getPersistentRecords() const {
   return _persistentRecords;
}

particles::pidt::records::State particles::pidt::records::StatePacked::convert() const{
   return State(
      getMinimalNumberOfParticlesPerCell(),
      getTimeStepSize(),
      getMaximalNumberOfInitialParticlesPerUnitVolume(),
...
#ifdef Parallel
   tarch::logging::Log particles::pidt::records::StatePacked::_log( "particles::pidt::records::StatePacked" );
   
   MPI_Datatype particles::pidt::records::StatePacked::Datatype = 0;
   MPI_Datatype particles::pidt::records::StatePacked::FullDatatype = 0;
   
   
   void particles::pidt::records::StatePacked::initDatatype() {
      {
   ...
   void particles::pidt::records::StatePacked::shutdownDatatype() {
      MPI_Type_free( &StatePacked::Datatype );
      MPI_Type_free( &StatePacked::FullDatatype );
      
   }
   
   void particles::pidt::records::StatePacked::send(int destination, int tag, bool exchangeOnlyAttributesMarkedWithParallelise, bool communicateBlocking) {
      _senderDestinationRank = destination;
      ...
      if (communicateBlocking) {
         ...
         if  (result!=MPI_SUCCESS) {
            std::ostringstream msg;
            msg << "was not able to send message particles::pidt::records::StatePacked "
            << toString()
            << " to node " << destination
            << ": " << tarch::parallel::MPIReturnValueToString(result);
            _log.error( "send(int)",msg.str() );
      ...
      while (!flag) {
         ...
         if (result!=MPI_SUCCESS) {
            std::ostringstream msg;
            msg << "testing for finished send task for particles::pidt::records::StatePacked "
            << toString()
            << " sent to node " << destination
            << " failed: " << tarch::parallel::MPIReturnValueToString(result);
            _log.error("send(int)", msg.str() );
         ...
         if (
            ...
            tarch::parallel::Node::getInstance().writeTimeOutWarning(
            "particles::pidt::records::StatePacked",
            "send(int)", destination,tag,1
            );
            triggeredTimeoutWarning = true;
         }
...
void particles::pidt::records::StatePacked::receive(int source, int tag, bool exchangeOnlyAttributesMarkedWithParallelise, bool communicateBlocking) {
   if (communicateBlocking) {
      ...
      if ( result != MPI_SUCCESS ) {
         std::ostringstream msg;
         msg << "failed to start to receive particles::pidt::records::StatePacked from node "
         << source << ": " << tarch::parallel::MPIReturnValueToString(result);
         _log.error( "receive(int)", msg.str() );
      }
      ...
      while (!flag) {
         ...
         if (result!=MPI_SUCCESS) {
            std::ostringstream msg;
            msg << "testing for finished receive task for particles::pidt::records::StatePacked failed: "
            << tarch::parallel::MPIReturnValueToString(result);
            _log.error("receive(int)", msg.str() );
         }
...
bool particles::pidt::records::StatePacked::isMessageInQueue(int tag, bool exchangeOnlyAttributesMarkedWithParallelise) {
   MPI_Status status;
   int  flag        = 0;
   MPI_Iprobe(
      MPI_ANY_SOURCE, tag,
...
int particles::pidt::records::StatePacked::getSenderRank() const {
   assertion( _senderDestinationRank!=-1 );
   return _senderDestinationRank;
