#ifndef _PARTICLES_PIDT_RECORDS_STATE_H
#define _PARTICLES_PIDT_RECORDS_STATE_H
...
namespace particles {
    ...
    */
   class particles::pidt::records::State { 
      
      public:
         
         typedef particles::pidt::records::StatePacked Packed;
         
         struct PersistentRecords {
            int _minimalNumberOfParticlesPerCell;
            double _timeStepSize;
            double _maximalNumberOfInitialParticlesPerUnitVolume;
            double _maximalInitialVelocity;
            double _breakingDamWidth;
            double _numberOfLifts;
            double _numberOfParticlesInLeaves;
            #ifdef UseManualAlignment
            tarch::la::Vector<MaxLevels,double> _liftsPerLevel __attribute__((aligned(VectorisationAlignment)));
            #else
            tarch::la::Vector<MaxLevels,double> _liftsPerLevel;
            #endif
            double _accumulatedDensity;
            double _nonEmptyLeaves;
            double _particlesSentToMaster;
            #ifdef UseManualAlignment
 ...
 #endif 
 {
            ...
            inline double getMaximalNumberOfInitialParticlesPerUnitVolume() const 
 #ifdef UseManualInlining
 __attribute__((always_inline))
 #endif 
 {
               return _maximalNumberOfInitialParticlesPerUnitVolume;
            }
            
            
            
            inline void setMaximalNumberOfInitialParticlesPerUnitVolume(const double& maximalNumberOfInitialParticlesPerUnitVolume) 
 #ifdef UseManualInlining
 __attribute__((always_inline))
 #endif 
 {
            ...
            inline double getMaximalInitialVelocity() const 
 #ifdef UseManualInlining
 __attribute__((always_inline))
 #endif 
 {
               return _maximalInitialVelocity;
            }
            
            
            
            inline void setMaximalInitialVelocity(const double& maximalInitialVelocity) 
 #ifdef UseManualInlining
 __attribute__((always_inline))
 #endif 
 {
            ...
            inline double getBreakingDamWidth() const 
 #ifdef UseManualInlining
 __attribute__((always_inline))
 #endif 
 {
               return _breakingDamWidth;
            }
            
            
            
            inline void setBreakingDamWidth(const double& breakingDamWidth) 
 #ifdef UseManualInlining
 __attribute__((always_inline))
 #endif 
 {
            ...
            inline double getNumberOfLifts() const 
 #ifdef UseManualInlining
 __attribute__((always_inline))
 #endif 
 {
            ...
            inline void setNumberOfLifts(const double& numberOfLifts) 
 #ifdef UseManualInlining
 __attribute__((always_inline))
 #endif 
 {
            ...
            inline double getNumberOfParticlesInLeaves() const 
 #ifdef UseManualInlining
 __attribute__((always_inline))
 #endif 
 {
               return _numberOfParticlesInLeaves;
            }
            
            
            
            inline void setNumberOfParticlesInLeaves(const double& numberOfParticlesInLeaves) 
 #ifdef UseManualInlining
 __attribute__((always_inline))
 #endif 
 {
             ...
             * @see convert()
             */
            inline tarch::la::Vector<MaxLevels,double> getLiftsPerLevel() const 
 #ifdef UseManualInlining
 __attribute__((always_inline))
 #endif 
 {
               return _liftsPerLevel;
            }
             ...
             * @see convert()
             */
            inline void setLiftsPerLevel(const tarch::la::Vector<MaxLevels,double>& liftsPerLevel) 
 #ifdef UseManualInlining
 __attribute__((always_inline))
 #endif 
 {
            ...
            inline double getAccumulatedDensity() const 
 #ifdef UseManualInlining
 __attribute__((always_inline))
 #endif 
 {
               return _accumulatedDensity;
            }
            
            
            
            inline void setAccumulatedDensity(const double& accumulatedDensity) 
 #ifdef UseManualInlining
 __attribute__((always_inline))
 #endif 
 {
            ...
            inline double getNonEmptyLeaves() const 
 #ifdef UseManualInlining
 __attribute__((always_inline))
 #endif 
 {
               return _nonEmptyLeaves;
            }
            
            
            
            inline void setNonEmptyLeaves(const double& nonEmptyLeaves) 
 #ifdef UseManualInlining
 __attribute__((always_inline))
 #endif 
 {
            ...
            inline double getParticlesSentToMaster() const 
 #ifdef UseManualInlining
 __attribute__((always_inline))
 #endif 
 {
               return _particlesSentToMaster;
            }
            
            
            
            inline void setParticlesSentToMaster(const double& particlesSentToMaster) 
 #ifdef UseManualInlining
 __attribute__((always_inline))
 #endif 
 {
 ...
 #endif 
 {
            return _persistentRecords._minimalNumberOfParticlesPerCell;
         }
 ...
 #endif 
 {
            _persistentRecords._minimalNumberOfParticlesPerCell = minimalNumberOfParticlesPerCell;
         }
 ...
 #endif 
 {
            return _persistentRecords._maximalNumberOfInitialParticlesPerUnitVolume;
         }
 ...
 #endif 
 {
            _persistentRecords._maximalNumberOfInitialParticlesPerUnitVolume = maximalNumberOfInitialParticlesPerUnitVolume;
         }
 ...
 #endif 
 {
            return _persistentRecords._maximalInitialVelocity;
         }
 ...
 #endif 
 {
            _persistentRecords._maximalInitialVelocity = maximalInitialVelocity;
         }
 ...
 #endif 
 {
            return _persistentRecords._breakingDamWidth;
         }
 ...
 #endif 
 {
            _persistentRecords._breakingDamWidth = breakingDamWidth;
         }
 ...
 #endif 
 {
            return _persistentRecords._numberOfLifts;
         }
 ...
 #endif 
 {
            _persistentRecords._numberOfLifts = numberOfLifts;
         }
 ...
 #endif 
 {
            return _persistentRecords._numberOfParticlesInLeaves;
         }
 ...
 #endif 
 {
            _persistentRecords._numberOfParticlesInLeaves = numberOfParticlesInLeaves;
         }
 ...
 #endif 
 {
            return _persistentRecords._liftsPerLevel;
         }
 ...
 #endif 
 {
            _persistentRecords._liftsPerLevel = (liftsPerLevel);
         }
         
         
         
         inline double getLiftsPerLevel(int elementIndex) const 
 #ifdef UseManualInlining
 __attribute__((always_inline))
 #endif 
 {
            assertion(elementIndex>=0);
            assertion(elementIndex<MaxLevels);
            return _persistentRecords._liftsPerLevel[elementIndex];
            
         }
         
         
         
         inline void setLiftsPerLevel(int elementIndex, const double& liftsPerLevel) 
 #ifdef UseManualInlining
 __attribute__((always_inline))
 #endif 
 {
            assertion(elementIndex>=0);
            assertion(elementIndex<MaxLevels);
            _persistentRecords._liftsPerLevel[elementIndex]= liftsPerLevel;
 ...
 #endif 
 {
            return _persistentRecords._accumulatedDensity;
         }
 ...
 #endif 
 {
            _persistentRecords._accumulatedDensity = accumulatedDensity;
         }
 ...
 #endif 
 {
            return _persistentRecords._nonEmptyLeaves;
         }
 ...
 #endif 
 {
            _persistentRecords._nonEmptyLeaves = nonEmptyLeaves;
         }
 ...
 #endif 
 {
            return _persistentRecords._particlesSentToMaster;
         }
 ...
 #endif 
 {
            _persistentRecords._particlesSentToMaster = particlesSentToMaster;
         }
 ...
 #endif 
 {
       ...
       * @date   06/02/2014 16:27
       */
      class particles::pidt::records::StatePacked { 
         ...
         public:
            ...
            struct PersistentRecords {
               ...
               || Member 	|| startbit 	|| length
                ...
                |  couldNotEraseDueToDecompositionFlag	| startbit 6	| #bits 1
                |  subWorkerIsInvolvedInJoinOrFork	| startbit 7	| #bits 1
                */
 ...
 #endif 
 {
   ...
   _packedRecords0 = static_cast<short int>( subWorkerIsInvolvedInJoinOrFork ? (_packedRecords0 | mask) : (_packedRecords0 & ~mask));
         ...
         public:
             ...
             * Generated
             */
            StatePacked(const int& minimalNumberOfParticlesPerCell, const double& timeStepSize, const double& maximalNumberOfInitialParticlesPerUnitVolume, const double& maximalInitialVelocity, const double& breakingDamWidth, const double& numberOfLifts, const double& numberOfParticlesInLeaves, const tarch::la::Vector<MaxLevels,double>& liftsPerLevel, const double& accumulatedDensity, const double& nonEmptyLeaves, const double& particlesSentToMaster, const tarch::la::Vector<DIMENSIONS,double>& minMeshWidth, const tarch::la::Vector<DIMENSIONS,double>& maxMeshWidth, const double& numberOfInnerVertices, const double& numberOfBoundaryVertices, const double& numberOfOuterVertices, const double& numberOfInnerCells, const double& numberOfOuterCells, const double& numberOfInnerLeafVertices, const double& numberOfBoundaryLeafVertices, const double& numberOfOuterLeafVertices, const double& numberOfInnerLeafCells, const double& numberOfOuterLeafCells, const int& maxLevel, const bool& hasRefined, const bool& hasTriggeredRefinementForNextIteration, const bool& hasErased, const bool& hasTriggeredEraseForNextIteration, const bool& hasChangedVertexOrCellState, const bool& isTraversalInverted, const bool& reduceStateAndCell, const bool& couldNotEraseDueToDecompositionFlag, const bool& subWorkerIsInvolvedInJoinOrFork);
